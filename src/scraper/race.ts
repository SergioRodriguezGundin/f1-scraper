...
import { F1_URL, F1_YEAR, RESULTS, getFastestLapsUrl, getPitStopsUrl, getPracticeUrlById, getQualifyingUrl, getRaceResultUrl, getSprintGridUrl, getSprintQualifyingUrl, getSprintRaceUrl, getStartingGridUrl, racesMap, setYear } from '../utils/globals';
